<?php
/*
Plugin Name: Payme by FGS
Plugin URI:  https://github.com/GregoryFS/payme_woocomerce_plagin
Description: Плагин WooCommerce для для интеграции с Payme
Version: 1.0
Author: fsgregory@yandex.ru, Фурсов Григорий
Text Domain: payme
 */
...
text-align: center;
width: 100%;
text-decoration: underline;" href="{$order->get_cancel_order_url()}">$label_cancel</a>
</form>
FORM;
...
function rudr_gateway_block_support() {
	...
	require_once __DIR__ . '/includes/class-wc-payme-gateway-blocks-support.php';

	// registering the PHP class we have just included
	add_action(
		'woocommerce_blocks_payment_method_type_registration',
		function( Automattic\WooCommerce\Blocks\Payments\PaymentMethodRegistry $payment_method_registry ) {
			$payment_method_registry->register( new WC_Payme_Gateway_Blocks_Support('payme') );
		}
	);
...
// echo 'asdasdasdasd';
// if (!function_exists('payme_success_query_vars')) {
