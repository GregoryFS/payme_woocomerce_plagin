...
final class WC_Payme_Gateway_Blocks_Support extends AbstractPaymentMethodType {
	
	private $gateway;
	
	protected $name = 'payme'; // payment gateway id
	...
	public function get_payment_method_script_handles() {
		...
		return array( 'wc-payme-blocks-integration' );
	...
	public function get_payment_method_data() {
      ...
      'title'        => $this->get_setting( 'title' ),
			...
			//'title'        => 'Payme',
			//'description'  => 'Описание Payme',

      'icon'         => plugin_dir_url( __DIR__ ) . 'assets/payme.png',
